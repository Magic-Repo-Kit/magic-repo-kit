...
public class AuthUtil {
    ...
    public static MRKUser getUser(HttpServletRequest request){
        ...
        return new MRKUser(userId,name,realName,account,deptId,postId,roleId);
    }
