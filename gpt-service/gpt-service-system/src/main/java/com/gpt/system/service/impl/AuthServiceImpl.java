...
import com.gpt.system.constant.SystemUserStatus;
import com.gpt.system.dto.auth.AuthLoginDTO;
...
import com.gpt.system.mail.MailUtil;
import com.gpt.system.vo.auth.AuthTokenVO;
import com.gpt.system.service.IAuthService;
...
public class AuthServiceImpl implements IAuthService {
    ...
    @Value("${gpt.auth.local.client-id}")
    private final String clientId = null;
    @Value("${gpt.auth.local.client-secret}")
    ...
    public Boolean sendCode(Integer type, String email) {
        ...
        MailUtil.sendHtml(email, "gpt 认证消息", context, null);
        return true;
    }
