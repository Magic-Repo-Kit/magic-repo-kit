package com.gpt.system.constant;

import com.gpt.common.api.IResultCode;
import com.gpt.i18n.utils.MessageUtil;
...
public enum SystemResultCode implements IResultCode {
    ...
    //邮箱格式错误
    EMAIL_FORMAT_ERROR(10010208,"EMAIL_FORMAT_ERROR"),
    //邮件已经发送
    EMAIL_SEND(10010209,"EMAIL_SEND"),
    //邮箱错误
    EMAIL_ERROR(10010210, "EMAIL_ERROR"),
    //验证码错误
    CAPTCHA_ERROR(10010211, "CAPTCHA_ERROR"),
    //两次密码不一致
    PASSWORD_NOT_EQUAL(10010212, "PASSWORD_NOT_EQUAL");
